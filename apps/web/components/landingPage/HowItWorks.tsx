...
const HowItWorks = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "Paste a YouTube Link/ add video source(coming soon)",
      description:
        "Simply drop in a link to any YouTube video with valuable content you want to share.",
    },
    {
      icon: <Database className="h-8 w-8 text-yellow-500" />,
      title: "Generate High-Quality Threads/tweets",
      description:
        "Set the length and tone.Our AI watches the video, understands the content, and crafts a killer Twitter thread in your tone.",
    },
    {
      icon: <Share className="h-8 w-8 text-yellow-500" />,
      title: "Edit or Schedule(coming soon), or Share Instantly",
      description:
        "Tweak the output, schedule it for later, or post it right away — all from one place.",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="mx-auto max-w-2xl text-neutral-500 dark:text-gray-400">
            Turn any valuable video into scroll-stopping Twitter threads — from
            pasting links to sharing your voice, it’s all seamless.
          </p>
        </motion.div>
